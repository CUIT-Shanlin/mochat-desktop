...
export const api = {
  ...
  startGroupCall: (sessionId: string, groupId: EntityId, callKind: 'voice' | 'video' = 'voice') =>
    callRequest<CallSession>('/calls/group/start', { method: 'POST', body: JSON.stringify({ sessionId, groupId, callKind }) }),
